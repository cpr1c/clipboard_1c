...
#КонецЕсли
	...
	Возврат Новый ("AddIn." + ИдентификаторКомпоненты() + ".WindowsControl");
КонецФункции
...
Функция ВерсияКомпоненты(ОбъектКомпоненты = Неопределено) Экспорт
	...
	Возврат ОбъектКомпоненты.Версия;
КонецФункции

Процедура ОчиститьБуферОбмена(ОбъектКомпоненты = Неопределено) Экспорт
	ОбъектКомпоненты=ОбъектКомпонентыРаботыСБуферомОбмена(ОбъектКомпоненты);
	ОбъектКомпоненты.ОчиститьБуферОбмена();
КонецПроцедуры
...
Процедура КопироватьКартинкуВБуфер(Картинка, ОбъектКомпоненты = Неопределено) Экспорт
	...
	ОбъектКомпоненты=ОбъектКомпонентыРаботыСБуферомОбмена(ОбъектКомпоненты);
	ОбъектКомпоненты.КартинкаБуфераОбмена=ДвоичныеДанные;
...
Функция ПолучитьКартинкуИзБуфера(ОбъектКомпоненты = Неопределено, ВариантПолучения = "Картинка") Экспорт
	ОбъектКомпоненты=ОбъектКомпонентыРаботыСБуферомОбмена(ОбъектКомпоненты);
	ДанныеКартинкиВБуфере=ОбъектКомпоненты.КартинкаБуфераОбмена;
...
Процедура КопироватьСтрокуВБуфер(СтрокаКопирования, ОбъектКомпоненты = Неопределено) Экспорт
	ОбъектКомпоненты=ОбъектКомпонентыРаботыСБуферомОбмена(ОбъектКомпоненты);
	ОбъектКомпоненты.ТекстБуфераОбмена=СтрокаКопирования;
...
Функция ПолучитьТекстИзБуфера(ОбъектКомпоненты = Неопределено) Экспорт
	ОбъектКомпоненты=ОбъектКомпонентыРаботыСБуферомОбмена(ОбъектКомпоненты);
	Возврат ОбъектКомпоненты.ТекстБуфераОбмена;
